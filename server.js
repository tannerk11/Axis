...
app.get('/api/conferences/:conference/summary', async (req, res) => {
  try {
    const { conference } = req.params;
    const { league = 'mens', season = DEFAULT_SEASON } = req.query;
...
// Get national averages for radar chart comparison
app.get('/api/national-averages', async (req, res) => {
  try {
    const { league = 'mens', season = DEFAULT_SEASON } = req.query;
...
// Get conference head-to-head matrix
app.get('/api/conferences/:conference/head-to-head', async (req, res) => {
  try {
    const { conference } = req.params;
    const { league = 'mens', season = DEFAULT_SEASON } = req.query;
    const confName = decodeURIComponent(conference);
...
app.get('/api/conference-rankings', async (req, res) => {
  try {
    const { league = 'mens', season = DEFAULT_SEASON } = req.query;
...
app.get('/api/conference-rpi-scatter', async (req, res) => {
  try {
    const { league = 'mens', season = DEFAULT_SEASON } = req.query;
